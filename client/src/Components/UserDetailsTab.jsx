...
export const UserDetailsTab = (props) => {
	...
	return (
		...
		<div className='mt-12 flex flex-col justify-center items-center '>
			...
			<div className=' w-2/3 mx-auto h-12 pt-2 text-center font-bold text-2xl rounded-t-[13px] mt-4 bg-ouryellow hover:bg-yellow-500'>Your Subscribed Products</div>
			<UserSubsProducts />
			</div>
			<div className='w-11/12 mt-8'>
			<div className=' w-2/3 mx-auto h-12 pt-2 text-center font-bold text-2xl rounded-t-[13px] mt-4 bg-ouryellow hover:bg-yellow-500'>Your Past Orders</div>
			<UserOrders />
			</div>
		</div>
		</div> 
